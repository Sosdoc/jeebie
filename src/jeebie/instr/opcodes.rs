...
pub static CB_OPCODE_TABLE : [OpcodeFunc; 256] = [
    ...
    // 0x80
          ...
          RES_0_H,       RES_0_L,     RES_0_HLm,       RES_0_A,
          RES_1_B,       RES_1_C,       RES_1_D,       RES_1_E,
          RES_1_H,       RES_1_L,     RES_1_HLm,       RES_1_A,
    // 0x90
          RES_2_B,       RES_2_C,       RES_2_D,       RES_2_E,
          RES_2_H,       RES_2_L,     RES_2_HLm,       RES_2_A,
          RES_3_B,       RES_3_C,       RES_3_D,       RES_3_E,
          RES_3_H,       RES_3_L,     RES_3_HLm,       RES_3_A,
    // 0xa0
          RES_4_B,       RES_4_C,       RES_4_D,       RES_4_E,
          RES_4_H,       RES_4_L,     RES_4_HLm,       RES_4_A,
          RES_5_B,       RES_5_C,       RES_5_D,       RES_5_E,
          RES_5_H,       RES_5_L,     RES_5_HLm,       RES_5_A,
    // 0xb0
          RES_6_B,       RES_6_C,       RES_6_D,       RES_6_E,
          RES_6_H,       RES_6_L,     RES_6_HLm,       RES_6_A,
          RES_7_B,       RES_7_C,       RES_7_D,       RES_7_E,
          RES_7_H,       RES_7_L,     RES_7_HLm,       RES_7_A,
    // 0xc0
          SET_0_B,       SET_0_C,       SET_0_D,       SET_0_E,
          SET_0_H,       SET_0_L,     SET_0_HLm,       SET_0_A,
          SET_1_B,       SET_1_C,       SET_1_D,       SET_1_E,
          SET_1_H,       SET_1_L,     SET_1_HLm,       SET_1_A,
    // 0xd0
          SET_2_B,       SET_2_C,       SET_2_D,       SET_2_E,
          SET_2_H,       SET_2_L,     SET_2_HLm,       SET_2_A,
          SET_3_B,       SET_3_C,       SET_3_D,       SET_3_E,
          SET_3_H,       SET_3_L,     SET_3_HLm,       SET_3_A,
    // 0xe0
          SET_4_B,       SET_4_C,       SET_4_D,       SET_4_E,
          SET_4_H,       SET_4_L,     SET_4_HLm,       SET_4_A,
          SET_5_B,       SET_5_C,       SET_5_D,       SET_5_E,
          SET_5_H,       SET_5_L,     SET_5_HLm,       SET_5_A,
    // 0xf0
          SET_6_B,       SET_6_C,       SET_6_D,       SET_6_E,
          SET_6_H,       SET_6_L,     SET_6_HLm,       SET_6_A,
          SET_7_B,       SET_7_C,       SET_7_D,       SET_7_E,
          SET_7_H,       SET_7_L,     SET_7_HLm,       SET_7_A,
];